...
print ("<html>")
print ('<head>')
print ("<title>Radio Configurator v2</title>")
print ('</head>')
print ('<body>')
print ("<h2>Radio Configurator v2</h2>")
...
command_line = 'streamIQ ' + str(adc_freq_hz) + ' ' + str(tune_freq_hz)
